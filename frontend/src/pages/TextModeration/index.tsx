...
import styles from "@/pages/TextModeration/index.module.css"
import ServicePageContentLayout from "@/components/ServicePageContentLayout";
import ServiceInfoCard from "@/components/ServiceInfoCard";

const index = () => {
    document.title = "TEXT MODERATION | CLOUD";
                    ...
                    <div className={styles.playgroundWrapper}>
                        <div className={styles.playgroundSection}>
                            <div className={styles.requestContainer}>
                                <div className={styles.requestContent} contentEditable placeholder="Type Request Text"></div>
                            </div>
                        </div>
                        <div className={styles.playgroundSection}>
