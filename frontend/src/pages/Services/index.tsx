...
const HeroSky = () => {
  return (
    <div className={styles.heroSky + " icon"}>
      ...
      >
        <path
          d="M73.6667 160C53.4444 160 36.1644 154.75 21.8267 144.25C7.48888 133.75 0.324432 120.917 0.333321 105.75C0.333321 92.75 5.55554 81.1667 16 71C26.4444 60.8333 40.1111 54.3333 57 51.5C62.5556 36.1667 73.6667 23.75 90.3333 14.25C107 4.75 125.889 0 147 0C173 0 195.058 6.79333 213.173 20.38C231.289 33.9667 240.342 50.5067 240.333 70C255.667 71.3333 268.391 76.2933 278.507 84.88C288.622 93.4667 293.676 103.507 293.667 115C293.667 127.5 287.831 138.127 276.16 146.88C264.489 155.633 250.324 160.007 233.667 160H73.6667Z"
          fill="white"
