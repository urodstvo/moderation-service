...
export const Pricing = () => {
    ...
    useEffect(() => {if (isSuccess) dispatch(setRole({role: RoleEnum.Student}))}, [isSuccess])
    
    const choosePlan = async (role: RoleEnum) => {await changeRole(role)}
            ...
            <div className={styles.plansContainer}>
                <div className={styles.plansContent}>
                    <PlanCard 
                        ...
                        disabled={!user?.is_verified || user.role !== RoleEnum.User || isLoading}
