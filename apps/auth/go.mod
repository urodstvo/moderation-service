...
require (
	...
	github.com/urodstvo/moderation-service/libs/logger v0.0.0-00010101000000-000000000000 // indirect
	github.com/urodstvo/moderation-service/libs/nats v0.0.0-00010101000000-000000000000 // indirect
